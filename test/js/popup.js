...
(function (factory) {
    ...
    Popup.prototype.show = function (_relatedTarget) {
        ...
        $element.removeClass().toggleClass('popup ' + classes);
    ...
    function Plugin(options, _relatedTarget) {
        return this.each(function () {
            ...
            var optionset = $.extend({}, Popup.prototype.defaults, $this.data(), (typeof options === 'undefined' ? 'undefined' : _typeof(options)) === 'object' && options);
