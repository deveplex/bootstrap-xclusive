...
(function (factory) {
    ...
    CheckBox.prototype.initialize = function () {
        ...
        $element.on('change', function () {
            ...
            var id = $(this).attr('id');
            if (!$(this).prop('checked')) $(this).parent('label').removeClass('checked').removeClass(options.font);else $(this).parent('label').addClass('checked').addClass(options.font);
        });
    };
    ...
    function Plugin(options, _relatedTarget) {
        return this.each(function () {
            ...
            var optionset = $.extend({}, CheckBox.prototype.defaults, $this.data(), (typeof options === 'undefined' ? 'undefined' : _typeof(options)) === 'object' && options);
...
(function (factory) {
    ...
    var RadioBox = function RadioBox(element, options) {
        this.element = element;
        this.options = options;
        this.type = 'radiobox';
    ...
    RadioBox.prototype.initialize = function () {
        ...
        if ($element.prop('disabled')) $element.parents('.radiobox').addClass('disabled'); //.siblings().addClass('disabled');
        ...
        .on('propertychange', function (e, data) {
            if (data.property === 'disabled') var disabled;else if (data.property === 'checked') var checked;
    ...
    function Plugin(options, _relatedTarget) {
        return this.each(function () {
            ...
            var optionset = $.extend({}, RadioBox.prototype.defaults, $this.data(), (typeof options === 'undefined' ? 'undefined' : _typeof(options)) === 'object' && options);
